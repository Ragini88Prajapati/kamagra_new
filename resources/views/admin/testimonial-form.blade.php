    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-body">
                    <form
                        action="{{ isset($action) && $action  == 'update'? route('admin.testimonial.update') : route('admin.testimonial.insert') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                            if(old('name') != null){
                                                ...
                                                $name_value = isset($blogs->name) && !empty($blogs->name) ? $blogs->name : "";;
                                            }
                                            ?>
