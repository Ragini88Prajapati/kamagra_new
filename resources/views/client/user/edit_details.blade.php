...
<div class="container mt-5">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 offset-md-2 offset-lg-2 offset-xl-2" style="background-color: rgb(250, 250, 250);padding: 20px;">
            ...
            <form action="{{ route('auth.register.register_client_user') }}" method="POST" id="register-form" class="signup-form">
                @csrf
                ...
                <div class="row mb--20 mt-3">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-sm--20">
                        <div class="form__group">
                            ...
                            <input type="text" tabindex="1" name="name" id="name" class="form__input" value="Shaikh Hamid" autocomplete="off">
                            @error('name')
                ...
                <div class="row mb--20 mt-3">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-sm--20">
                        <div class="form__group">
                            ...
                            <input type="text" tabindex="2" name="mobile_number" id="mobile_number" class="form__input" autocomplete="off" value="7696985632">
                            @error('mobile_number')
                ...
                <div class="row mb--20">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="form__group">
                            ...
                            <input type="email" tabindex="3" name="email" id="email" class="form__input" autocomplete="off" value="shaikh@gmail.com">
                            @error('email')
